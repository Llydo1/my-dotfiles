...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting aliases zsh-256color)

# Change directory of zsh_compdump
...
case $terminal in
	*alacritty*)
		[[ ! -f ~/.p10kAlacritty.zsh ]] || source ~/.p10kAlacritty.zsh
	;;
	*)
